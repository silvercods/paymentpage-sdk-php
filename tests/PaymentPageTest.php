...
namespace sapihost\tests;

use sapihost\PaymentPage;
use sapihost\SignatureHandler;
use sapihost\Payment;
...
class PaymentPageTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetUrl()
    {
        ...
        self::assertEquals(
            'https://paymentpage.sapihost.com/payment?project_id=100&interface_type=%7B%22id%22%3A23%7D'
